...
plotMonthlyspending <- function(start,end,categories) {
  ...
  ## Create plot
  out <- ggplot(df_of_interest,
         mapping = aes(x = yearmo, y = -1 * activity / 1E3)) +
      geom_col() +
